...
function uniqueMember(acc, curr) {
...
const uniqueMembers = billMembers.reduce(uniqueMember, [])
const lengthMembers = uniqueMembers.length;

console.log("Unique Members Count: " + lengthMembers);